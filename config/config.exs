...
config :inmana, Inmana.Mailer, adapter: Bamboo.Adapter

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "43CdKj2a5Q/J2b4aqdG54h2U+PjuBYZ5sE1MlVA6YgM9woGdMq1YTma9C0e1wDdl",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "HyxN3VNv"]
